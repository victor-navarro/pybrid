...
def plot_comp(comp_file:str, out_file: str = "weightcomp.png"):
    ...
    range_min = all_comps["mean"].min()-.05
    range_max = all_comps["mean"].max()+.05
...
if __name__ == "__main__":
    ...
    if DO_COMP:
        comp_exp(exp_dir="results/exp_1_norm_e1/", seeds=list(range(1)))
    plot_comp("results/exp_1_norm_e1/weightcomp/weightcomp_all.csv", 
              "plots/exp_1_norm_e1/weightcomp_summary_across.png")
